...
import cz.cas.lib.bankid_registrator.entities.IdentifyAMLVerifiedClaims;
...
public class IdentifyAML extends IdentifyPlusClaims implements IProduct {
    ...
    private final IdentifyAMLVerifiedClaims verified_claims;
    ...
    public IdentifyAML(
            ...
            @JsonProperty("verified_claims") IdentifyAMLVerifiedClaims verified_claims) {
        super(
                title_prefix,
                title_suffix,
                given_name,
    ...
    public IdentifyAMLVerifiedClaims getVerified_claims() { return this.verified_claims; }
