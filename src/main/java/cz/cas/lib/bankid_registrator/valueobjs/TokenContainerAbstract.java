 ...
 * @author iok
 */
public abstract class TokenContainerAbstract implements TokenContainerIface {
    ...
    @Override
    public abstract void setIndicateSuccess(boolean indicateSuccess);

    @Override
    public abstract boolean getIndicateSuccess();
    ...
    @Override
    public abstract void setIdToken(String idToken);
